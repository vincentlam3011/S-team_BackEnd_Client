...
module.exports = {
    ...
    reviewFromEmployer: (review)=>{
        ...
        select u1.fullname, u2.email from users as u1, users as u2, reports as r where r.id_user1 = u1.id_user and r.id_user2 = u2.id_user and r.id_applicant = ${review.id_applicant};
        `);
    },
    ...
    // },
    detailReview: (id_applicant)=>{
        return db.query(`
        select * from accepted where id_applicant = ${id_applicant};
        `);
    },
}
